...
class CustomOptions extends AbstractModifier
{
	...
	//Added QTY
	const FIELD_QTY_OPTION_TITLE = 'qty_option';
    ...
    protected function getStaticTypeContainerConfig($sortOrder)
    {
        return [
            ...
            'children' => [
			    ...
			    static::FIELD_QTY_OPTION_TITLE => $this->getQtyOptionFieldConfig(25),
            ...
            'children' => [
                'record' => [
                    ...
                    'children' => [
						...
						static::FIELD_QTY_OPTION_TITLE => $this->getQtyOptionFieldConfig(35),
	...
	protected function getQtyOptionFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'componentType' => Field::NAME,
                        'formElement' => Input::NAME,
                        'dataScope' => static::FIELD_QTY_OPTION_TITLE,
                        'dataType' => Text::NAME,
                        'sortOrder' => $sortOrder,
                    ],
                ],
